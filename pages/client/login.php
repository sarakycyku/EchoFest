...
<head>
    ...
    <style>
         body {
    background-image: url('/EchoFest/assets/images/bg.png');
...
?>
    ...
    <div class="retro-logo mt-1">
        <div class="logo-chrome">
            <img src="/EchoFest/assets/images/logo2-pabg.png" alt="Logo" width="150" height="150">
...
<p class="login-subtitle">Login</p>
            ...
            <form class="future-form" id="loginForm" method="POST" action="/EchoFest/actions/login_logic.php">
